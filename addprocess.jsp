...
try {
 ...
 String InsertQuery="insert into vechile (vechileno,ownername,address,chassisno,color,fuelused,regdate) values ('"+vechileno+"','"+ownername+"','"+address+"','"+chassisno+"','"+color+"','"+fuelused+"','"+regdate+"')";
